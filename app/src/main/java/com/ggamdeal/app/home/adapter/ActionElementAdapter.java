...
public class ActionElementAdapter extends RecyclerView.Adapter<ActionElementAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public ActionElementAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.homepage_middlecardview, parent, false);
        return new ActionElementAdapter.ViewHolder(itemView);
    }
