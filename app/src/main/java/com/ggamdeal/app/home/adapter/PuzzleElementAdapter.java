...
public class PuzzleElementAdapter extends RecyclerView.Adapter<PuzzleElementAdapter.ViewHolder> {
    ...
    public PuzzleElementAdapter(Fragment fragment) {
        this.fragment = fragment;
        getPuzzleDataFromFirestore();
    }

    @NonNull
    @Override
    public PuzzleElementAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.homepage_middlecardview, parent, false);
        return new PuzzleElementAdapter.ViewHolder(itemView);
    }
    ...
    private void getPuzzleDataFromFirestore() {
        CollectionReference colref = db.collection("Game").document("Steam").collection("Puzzle");
