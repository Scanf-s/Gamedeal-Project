...
public class AdventureElementAdapter extends RecyclerView.Adapter<AdventureElementAdapter.ViewHolder> {
    ...
    public AdventureElementAdapter(Fragment fragment) {
        this.fragment = fragment;
        getAdventureDataFromFirestore();
    }

    @NonNull
    @Override
    public AdventureElementAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.homepage_middlecardview, parent, false);
        return new AdventureElementAdapter.ViewHolder(itemView);
    }
    ...
    private void getAdventureDataFromFirestore() {
        CollectionReference colref = db.collection("Game").document("Steam").collection("Adventure");
